...
const navigationMenuTriggerStyle = cva(
  "cursor-pointer group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50",
);
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ...
    // Prevent Radix's default hover interactions
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      "data-[motion^=from-]:slide-in-from-top-2 data-[motion^=to-]:slide-in-from-bottom-2",
